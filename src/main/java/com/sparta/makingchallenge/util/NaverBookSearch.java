package com.sparta.makingchallenge.util;
...
public class NaverBookSearch {
    public String search(String query) {
        ...
        headers.add("X-Naver-Client-Id", "fdMisB5Chgw0ppVUekDW");
        headers.add("X-Naver-Client-Secret", "49PfgEeNit");
        String body = "";
    ...
    public static void main(String[] args) {
        NaverBookSearch naverBookSearch = new NaverBookSearch();
        naverBookSearch.search("love");
    }
